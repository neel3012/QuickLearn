                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 4em; text-align: center;">
                      <h2 style="color:red">QuickLearn Solutions</h2>
                      <p style="color:red">Welcome! We are pleased to have you onboard!</p>
...
`
  const mailOptions = {
    ...
    subject: `Welcome ${useraccess} to our QuickLearn student portal`,
    html: emailContent,
  };
