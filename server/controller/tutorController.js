...
exports.registerTutor = async (req, res) => {
  try {
    ...
    if(user.username!==dbusername){
      ...
      await tutor.save();
      sendRegistrationEmail(user.email,user.username)
...
const sendRegistrationEmail = (recipientEmail,useraccess) => {
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 4em; text-align: center;">
                      <h2 style="color:green">QuickLearn Solutions</h2>
                      <p style="color:green">Welcome! We are pleased to have you onboard as tutor in our community!</p>
...
`
  const mailOptions = {
    ...
    subject: `Welcome ${useraccess} to our QuickLearn Tutors community `,
    html: emailContent,
  };
